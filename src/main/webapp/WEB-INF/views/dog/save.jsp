...
<script>
    function year_check(){
        var year_check = document.getElementById("year1").value;
        var result = document.getElementById("dateBirth_result");
        var today = new Date();
    ...
    function month_check(){
        var month_check = document.getElementById("month1").value;
        var result = document.getElementById("dateBirth_result");
        if(month_check == "월"){
